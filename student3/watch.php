        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarExample01">
			...
			<li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link" style="color: #ffffffcc; font-size: 17px;" href="https://www.youtube.com/channel/UC5CF7mLQZhvx8O5GODZAhdA" rel="nofollow"
                  target="_blank">Subjects</a>
              </li>
              <li class="nav-item">
                <a class="nav-link"  style="color: #ffffffcc; font-size: 17px;" href="https://mdbootstrap.com/docs/standard/" target="_blank">Semesters</a>
              </li>
            </ul>
          </div>
          <ul class="navbar-nav me-auto mb-2 mb-lg-0 float-right" style="float: right;">
            <li class="nav-item float-right" style="float: right;" >
              <a class="nav-link" style="color: #ffffffcc; font-size: 17px;" href="https://mdbootstrap.com/docs/standard/" target="_blank">Logout</a>
            </li>
          </ul>
        </nav>
	<!-- Top navbar -->
				...
				<div class="p-1 pt-3">
					...
					<div class="row mt-4 border-bottom ">
						...
						<div class="col-9 pl-5 ">
							...
							<p>Presenting the full video "KHAIRIYAT (BONUS TRACK)" from the Bollywood movie "CHHICHHORE". The film is directed by Nitesh Tiwari and produced by Sajid Nadiadwala under the banner of Nadiadwala Grandson Entertainment. The film stars Sushant Singh Rajput, Shraddha Kapoor, Varun Sharma, Prateik Babbar and follows the lives of seven friends from 1992 to present day.<span id="dots">...</span>
	...
	<div style="display: none; " class="border-bottom" id="cmnt"> 
		...
		<div class="row mt-4 ml-5  ">
			<div class="col-12 pl-5 ">
				...
				<div class="col-12 m-2 hvr" onclick="reply()" style="color: #303030; font-weight: bold">Show Reply <i class="fas fa-angle-down"></i></div>
	...
	<div class="mt-1">
		...
		<div class="row">
              <?php
                    ...
                    ?>
                          <div id="p<?php echo $id; ?>"  class="col-md-2 pb-5">
