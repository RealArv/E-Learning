        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarExample01">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item">
                <a class="nav-link" style="color: #ffffffcc; font-size: 17px;" href="" rel="nofollow"
                  target="_blank">Home</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" style="color: #ffffffcc; font-size: 19px;" href="" rel="nofollow"
                  target="_blank">Subjects</a>
              </li>
              <li class="nav-item">
                <a class="nav-link"  style="color: #ffffffcc; font-size: 17px;" href="" target="_blank">Semesters</a>
              </li>
            </ul>
          </div>
          <ul class="navbar-nav me-auto mb-2 mb-lg-0 float-right" style="float: right;">
            <li class="nav-item float-right" style="float: right;" >
              <a class="nav-link" style="color: #ffffffcc; font-size: 17px;" href="" target="_blank">Logout</a>
            </li>
          </ul>
    </header>
