...
Class Faculty
{
    ...
    function addFac($fac, $pass, $desi, $quali, $email, $gender, $phone, $depID, $multipleDep, $HOD) {
        include ("connect.php");
        ...
        if($this->duplicateFac($email)==0){
            $sql1="INSERT INTO tbl_faculty(sName, Dep_ID, sPassword, sDesignation, sQualification, sEmail, sGender, iPhone, iCommon_Dep, iHod, iStatus)values('$fac', '$depID', '$pass', '$desi', '$quali', '$email', '$gender', '$phone','$multipleDep', '$HOD', 1)";
