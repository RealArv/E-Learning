<?php
	...
	if(isset($_POST['fname']))
	{
		...
		$facobj= new Faculty();
		$retval=$facobj->addFac($fac, $pass, $desi, $quali, $email, $gender, $phone, $depID, $multipleDep, $HOD);
		if($retval == 1) {
									...
									<div class="card-body bg-white">
										<form action="" method="POST">
											...
											<div class="form-group">
												<div class="form-check">
													<label class="form-check-label">
														<input name="hod" class="form-check-input" type="checkbox" value="1">
														<span class="form-check-sign">HOD</span>
													</label>
												</div>
											</div>
